...
const ensureAdminTables = async () => {
  ...
  if (existingLegalDocs.rows.length === 0) {
    ...
    await query(`
      ...
      WHERE version IN ('5.0.0', '1.0.0', '31.0.0', '32.0.0', '33.0.0', '34.0.0', '35.0.0', '36.0.0', '37.0.0', '38.0.0', '39.0.0', '40.0.0', '41.0.0', '42.0.0', '43.0.0', '44.0.0', '45.0.0', '46.0.0', '47.0.0', '48.0.0', '49.0.0', '50.0.0', '89.0.0', '90.0.0', '91.0.0', '93.0.0', '95.0.0')
    `);
  }
