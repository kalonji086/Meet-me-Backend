...
class MailService {
  ...
  async sendPortfolioApprovalEmail(email, name, portfolioTitle, slug, themeColor) {
    ...
    const content = `
      <div style="text-align: center; margin-bottom: 30px;">
        <div style="width: 80px; height: 80px; background-color: ${themeColor}; border-radius: 20px; display: inline-flex; align-items: center; justify-content: center; color: white; font-size: 32px; font-weight: 900;">
          ${portfolioTitle.charAt(0).toUpperCase()}
        </div>
      </div>
